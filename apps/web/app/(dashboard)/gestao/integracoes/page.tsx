...
export default async function IntegrationsPage({
  ...
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-xl font-semibold text-neutral-900">Google Agenda</h1>
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div>
                    <p className="font-medium text-neutral-900">{professional.displayName}</p>
                    {connection?.externalAccount ? (
                      <p className="text-sm text-neutral-500">{connection.externalAccount}</p>
                    ) : null}
                  </div>
                  <span
                ...
                <p className="mt-2 text-sm text-neutral-600">{estado.detail}</p>
